...
Csa=0.0012;   %Systemic arterial compliance (liters/(mmHg)-adjusted for 120/80 mmHg

dt=0.01*T;    %Time step duration (minutes)
        %This choice implies 100 timesteps per cardiac cycle.
klokmax=ceil(20*T/dt); %Total number of timesteps 
        %This choice implies simulation of 20 cardiac cycles for better steady state.
